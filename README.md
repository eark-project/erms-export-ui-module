...
![Structure of the content in the ERMS](https://raw.githubusercontent.com/magenta-aps/erms-export-ui-module/master/doc/erms-export.png)
...
An example of how to perfrom an extraction (assuming that you have create a mapping file and an EAD template as described above) can be see 
in this [video](https://www.youtube.com/watch?v=-L8WVfAZ3C8&index=1&list=PLj-yd-_ObnNfjfKS-lBpThD4xrs-NRAIU)
